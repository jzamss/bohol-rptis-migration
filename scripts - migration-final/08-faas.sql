...
select distinct
  ...
  1 as datacapture,
  0 as autonumber,
  concat(p.arp_year, '-', a.municipal_code, '-', repeat('0', 4 - length(a.brgy_code)), a.brgy_code, '-', repeat('0', 5 - length(a.arp_count)), a.arp_count) as utdno,
  concat(p.arp_year, '-', a.municipal_code, '-', repeat('0', 4 - length(a.brgy_code)), a.brgy_code, '-', repeat('0', 5 - length(a.arp_count)), a.arp_count) as tdno,
