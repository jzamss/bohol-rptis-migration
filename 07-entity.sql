...
update training_etracs255.entity set address_objid = null;

delete from training_etracs255.entity_address;
delete from training_etracs255.entityindividual;
delete from training_etracs255.entityjuridical;
delete from training_etracs255.entitymember;
delete from training_etracs255.entitymultiple;
delete from training_etracs255.entity;
